...
<div style="display:inline-block;width:80px;height:80px;background:linear-gradient(135deg,#6366f1,#8b5cf6);border-radius:20px;margin-bottom:20px;box-shadow:0 0 40px rgba(139,92,246,0.4);display:flex;align-items:center;justify-content:center;"><svg width="48" height="48" viewBox="0 0 48 48" fill="none"><ellipse cx="24" cy="24" rx="20" ry="9" stroke="white" stroke-width="2" stroke-opacity="0.9" transform="rotate(0 24 24)"/><ellipse cx="24" cy="24" rx="20" ry="9" stroke="white" stroke-width="2" stroke-opacity="0.7" transform="rotate(60 24 24)"/><ellipse cx="24" cy="24" rx="20" ry="9" stroke="white" stroke-width="2" stroke-opacity="0.7" transform="rotate(-60 24 24)"/><circle cx="24" cy="24" r="5" fill="white" fill-opacity="0.95"/><circle cx="42" cy="24" r="2.5" fill="#f9a8d4"/><circle cx="6" cy="24" r="2.5" fill="#f9a8d4"/><circle cx="33" cy="38" r="2.5" fill="#c084fc"/><circle cx="15" cy="10" r="2.5" fill="#c084fc"/><circle cx="15" cy="38" r="2.5" fill="#a5b4fc"/><circle cx="33" cy="10" r="2.5" fill="#a5b4fc"/></svg></div>
