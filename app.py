...
<div style="display:inline-block;width:80px;height:80px;background:linear-gradient(135deg,#6366f1,#8b5cf6);border-radius:20px;margin-bottom:20px;box-shadow:0 0 40px rgba(139,92,246,0.4);display:flex;align-items:center;justify-content:center;"><svg width="44" height="44" viewBox="0 0 48 48" fill="none"><rect x="10" y="14" width="28" height="26" rx="6" fill="white" fill-opacity="0.95"/><circle cx="18" cy="26" r="3" fill="#6366f1"/><circle cx="30" cy="26" r="3" fill="#8b5cf6"/><path d="M19 33c1.5 2 6.5 2 10 0" stroke="#a855f7" stroke-width="2.5" stroke-linecap="round"/><rect x="21" y="6" width="6" height="8" rx="3" fill="#c084fc"/><circle cx="24" cy="4" r="2.5" fill="#f9a8d4"/><line x1="4" y1="24" x2="10" y2="24" stroke="#a5b4fc" stroke-width="2.5" stroke-linecap="round"/><line x1="38" y1="24" x2="44" y2="24" stroke="#c084fc" stroke-width="2.5" stroke-linecap="round"/><circle cx="4" cy="24" r="2" fill="#818cf8"/><circle cx="44" cy="24" r="2" fill="#d8b4fe"/></svg></div>
